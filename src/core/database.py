...
class Database:
    """SQLite database manager using a single persistent connection"""
    ...
    async def connect(self):
        """Open the persistent connection and enable WAL mode."""
    ...
    @asynccontextmanager
    async def _db(self):
        """Yield the shared connection (no-op on exit — connection stays open)."""
